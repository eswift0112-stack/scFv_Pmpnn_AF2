...
folder_with_pdbs=scFv_Pmpnn_AF2/input_dir           # where are our input PDBs to start the cycle? This is also where data will end up
...
output_dir=scFv_Pmpnn_AF2/output_dir                # temp output directory where less important (mediary ProteinMPNN) data ends up
...
PMPNN=ProteinMPNN # the global path to where the ProteinMPNN github was cloned to locally
